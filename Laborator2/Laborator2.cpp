...
void Laborator2::Init()
{
	...
	// Create a mesh box using custom data
	{
		vector<VertexFormat> vertices
		{
			...
			VertexFormat(glm::vec3(3, -1, 1), glm::vec3(1, 0, 0)),
			VertexFormat(glm::vec3(-1, 3,  1), glm::vec3(0, 0, 1)),
			VertexFormat(glm::vec3(3, 3,  1), glm::vec3(0, 1, 0)),
			VertexFormat(glm::vec3(-1, -1,  5), glm::vec3(1, 0.5, 0.2)),
			VertexFormat(glm::vec3(3, -1,  5), glm::vec3(0.6, 0.2, 0.1)),
			VertexFormat(glm::vec3(-1, 3,  5), glm::vec3(0, 0.8, 0.2)),
			VertexFormat(glm::vec3(3, 3,  5), glm::vec3(0.3, 0.7, 0.1))
		};
...

	{
		vector<VertexFormat> vertices
		{
			...
			VertexFormat(glm::vec3(0, 0, 3), glm::vec3(0.2, 0.5, 0))
		};
...

	{
		vector<VertexFormat> vertices
		{
			VertexFormat(glm::vec3(-2, 1, 3), glm::vec3(1, 0, 0)),	// 0
			VertexFormat(glm::vec3(-2, 1, 0), glm::vec3(0, 1, 0)),	// 1
			VertexFormat(glm::vec3(-2, 4, 0), glm::vec3(0, 0, 1)),	// 2
			VertexFormat(glm::vec3(-2, 4, 3), glm::vec3(1, 0, 1)),	// 3
		};
...

	{
		...
		for (int i = 0; i < 100; i++) {
			vertices.push_back(VertexFormat(glm::vec3(cos(u), sin(u), 0), glm::vec3(1, 0, 1)));
			indices.push_back(i);
			u = u + 6.28  / 100;
		}
	...
	/*{
		...
		Mesh* circle = CreateMesh("circle", vertices, indices);
		meshes["circle"]->SetDrawMode(GL_LINE_STRIP);
...
void Laborator2::Update(float deltaTimeSeconds)
{
	...
	RenderMesh(meshes["tetrahedron"], shaders["VertexColor"], glm::vec3(2, 3, -3));

	RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(-3, 1.5, 1));

	RenderMesh(meshes["circle"], shaders["VertexColor"], glm::vec3(2, 1, 3));
